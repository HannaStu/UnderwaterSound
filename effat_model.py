...
# ADDED based on passt model easier to get balanced dataset in test function
    ...
    def test(self, results_folder: str, path_model: str, path_data: str) -> None:
        ...
        cls: np.mean(vectors, axis=0) if len(vectors) > 0 else np.zeros(self.num_classes)
        ...
        save_subset_confusion_matrix(class_map.keys(), results_folder, all_labels,all_preds,"")
